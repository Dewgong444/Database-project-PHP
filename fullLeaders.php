...
<html>
	<body>
    <div>
			<h2> Leaders of World of Warcraft </h2>
      <table>
        <tr>
          <th> First Name </th>
          <th> Last Name </th>
        ...
        <?php
				if(!($stmt = $mysqli->prepare("SELECT leaders.fname, leaders.lname, leaders.class, race.name FROM leaders INNER JOIN race ON leaders.rid = race.id"))){
